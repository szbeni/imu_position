...
class Quaternion:
    ...
    def to_euler_angles(self):
        ...
        if np.abs(self[1] * self[2] + self[3] * self[0] - 0.5) < 1e-8:
            ...
            roll = np.arctan2(2 * self[0] * self[1] - 2 * self[2]
                              * self[3], 1 - 2 * self[1] ** 2 - 2 * self[3] ** 2)
            yaw = np.arctan2(2 * self[0] * self[2] - 2 * self[1]
    ...
    def to_rot_mat(self):
        ...
        # a11 = 2*(self._q[0] * self._q[0] + self._q[1] * self._q[1]) - 1
        # a12 = 2*(self._q[1] * self._q[2] - self._q[0] * self._q[3])
        # a13 = 2*(self._q[1] * self._q[3] + self._q[0] * self._q[2])

        # a21 = 2*(self._q[1] * self._q[2] + self._q[0] * self._q[3])
        # a22 = 2*(self._q[0] * self._q[0] + self._q[2] * self._q[2]) - 1
        # a23 = 2*(self._q[2] * self._q[3] - self._q[0] * self._q[1])

        # a31 = 2*(self._q[1] * self._q[3] - self._q[0] * self._q[2])
        # a32 = 2*(self._q[2] * self._q[3] + self._q[0] * self._q[1])
        # a33 = 2*(self._q[0] * self._q[0] + self._q[3] * self._q[3]) - 1
        # https://github.com/xioTechnologies/Quaternion-MATLAB-Library/blob/master/quatern2rotMat.m
        a11 = 2*(self._q[0] * self._q[0] + self._q[1] * self._q[1]) - 1
        a12 = 2*(self._q[1] * self._q[2] + self._q[0] * self._q[3])
        a13 = 2*(self._q[1] * self._q[3] - self._q[0] * self._q[2])
        ...
        return np.array([[a11, a12, a13], [a22, a21, a23], [a31, a32, a33]])
